namespace ggb.enterprise.ibas.applicationservice.Service
{
    ...
    /// <summary>
    /// Defines the <see cref="Ques_ansService" />
    /// </summary>
    public class Ques_ansService : IQues_ansService
    {
        /// <summary>
        /// Defines the _repository
        /// </summary>
        private readonly IQues_ansRepository _repository;

        /// <summary>
        /// Initializes a new instance of the <see cref="Ques_ansService"/> class.
        /// </summary>
        /// <param name="repository">The repository<see cref="IQues_ansRepository"/></param>
        public Ques_ansService(IQues_ansRepository repository)
        {
        ...
        public ServiceResult GetQues_ans()
        {
        ...
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult GetQues_ans(int id)
        {
        ...
        /// <param name="refining">The refining<see cref="Refining"/></param>
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult GetQues_ans(Refining refining)
        {
        ...
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult Save(Ques_ans entity)
        {
            try
            {
        ...
        /// <param name="entity">The entity<see cref="Ques_ans"/></param>
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult Delete(Ques_ans entity)
        {
            try
            {
