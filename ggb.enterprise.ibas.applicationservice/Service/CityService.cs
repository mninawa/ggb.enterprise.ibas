namespace ggb.enterprise.ibas.applicationservice.Service
{
    ...
    public class CityService : ICityService
    {
        ...
        /// </summary>
        /// <param name="repository">The repository<see cref="ICityRepository"/></param>
        ...
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult GetCity(int id)
        {
        ...
        /// <param name="refining">The refining<see cref="Refining"/></param>
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult GetCity(Refining refining)
        {
        ...
        /// <param name="entity">The entity<see cref="City"/></param>
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult Delete(City entity)
        {
            try
            {
