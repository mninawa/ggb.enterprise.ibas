namespace ggb.enterprise.ibas.applicationservice.Service
{
    ...
    /// <summary>
    /// Defines the <see cref="SR_recommendService" />
    /// </summary>
    public class SR_recommendService : ISR_recommendService
    {
        /// <summary>
        /// Defines the _repository
        /// </summary>
        private readonly ISR_recommendRepository _repository;

        /// <summary>
        /// Initializes a new instance of the <see cref="SR_recommendService"/> class.
        /// </summary>
        /// <param name="repository">The repository<see cref="ISR_recommendRepository"/></param>
        public SR_recommendService(ISR_recommendRepository repository)
        {
        ...
        public ServiceResult GetSR_recommend()
        {
        ...
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult GetSR_recommend(int id)
        {
        ...
        /// <param name="refining">The refining<see cref="Refining"/></param>
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult GetSR_recommend(Refining refining)
        {
        ...
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult Save(SR_recommend entity)
        {
            try
            {
        ...
        /// <param name="entity">The entity<see cref="SR_recommend"/></param>
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult Delete(SR_recommend entity)
        {
            try
            {
