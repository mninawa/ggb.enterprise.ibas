namespace ggb.enterprise.ibas.applicationservice.Service
{
    ...
    public class AddressService : IAddressService
    {
        ...
        /// </summary>
        /// <param name="repository">The repository<see cref="IAddressRepository"/></param>
        ...
        public ServiceResult GetAddress()
        {
        ...
        /// <param name="refining">The refining<see cref="Refining"/></param>
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult GetAddress(Refining refining)
        {
        ...
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult Save(Address entity)
        {
            try
            {
        ...
        /// <param name="entity">The entity<see cref="Address"/></param>
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult Delete(Address entity)
        {
            try
            {
