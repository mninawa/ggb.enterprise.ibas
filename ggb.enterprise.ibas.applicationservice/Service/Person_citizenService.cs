namespace ggb.enterprise.ibas.applicationservice.Service
{
    ...
    /// <summary>
    /// Defines the <see cref="Person_citizenService" />
    /// </summary>
    public class Person_citizenService : IPerson_citizenService
    {
        /// <summary>
        /// Defines the _repository
        /// </summary>
        private readonly IPerson_citizenRepository _repository;

        /// <summary>
        /// Initializes a new instance of the <see cref="Person_citizenService"/> class.
        /// </summary>
        /// <param name="repository">The repository<see cref="IPerson_citizenRepository"/></param>
        public Person_citizenService(IPerson_citizenRepository repository)
        {
        ...
        public ServiceResult GetPerson_citizen()
        {
        ...
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult GetPerson_citizen(int id)
        {
        ...
        /// <param name="refining">The refining<see cref="Refining"/></param>
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult GetPerson_citizen(Refining refining)
        {
        ...
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult Save(Person_citizen entity)
        {
            try
            {
        ...
        /// <param name="entity">The entity<see cref="Person_citizen"/></param>
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult Delete(Person_citizen entity)
        {
            try
            {
