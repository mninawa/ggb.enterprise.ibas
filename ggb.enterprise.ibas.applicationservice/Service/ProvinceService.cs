namespace ggb.enterprise.ibas.applicationservice.Service
{
    ...
    /// <summary>
    /// Defines the <see cref="ProvinceService" />
    /// </summary>
    public class ProvinceService : IProvinceService
    {
        ...
        /// </summary>
        /// <param name="repository">The repository<see cref="IProvinceRepository"/></param>
        ...
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult GetProvince(int id)
        {
        ...
        /// <param name="refining">The refining<see cref="Refining"/></param>
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult GetProvince(Refining refining)
        {
