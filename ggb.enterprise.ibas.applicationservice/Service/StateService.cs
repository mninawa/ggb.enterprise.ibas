namespace ggb.enterprise.ibas.applicationservice.Service
{
    ...
    public class StateService : IStateService
    {
        ...
        /// </summary>
        /// <param name="repository">The repository<see cref="IStateRepository"/></param>
        ...
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult GetState(int id)
        {
        ...
        /// <param name="refining">The refining<see cref="Refining"/></param>
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult GetState(Refining refining)
        {
        ...
        /// <param name="entity">The entity<see cref="State"/></param>
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult Delete(State entity)
        {
            try
            {
