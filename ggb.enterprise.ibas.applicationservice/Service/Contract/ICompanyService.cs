namespace ggb.enterprise.ibas.applicationservice.Contract
{
    ...
    public interface ICompanyService
    {
        ...
        /// <returns>The <see cref="ServiceResult"/></returns>
        ServiceResult GetCompany(int id);
        ...
        /// <param name="refining">The refining<see cref="Refining"/></param>
        /// <returns>The <see cref="ServiceResult"/></returns>
        ServiceResult GetCompany(Refining refining);
        ...
        /// <returns>The <see cref="ServiceResult"/></returns>
        ServiceResult Save(Company entity);
        ...
        /// <param name="entity">The entity<see cref="Company"/></param>
        /// <returns>The <see cref="ServiceResult"/></returns>
        ServiceResult Delete(Company entity);
    }
}
