namespace ggb.enterprise.ibas.applicationservice.Service
{
    ...
    /// <summary>
    /// Defines the <see cref="CommService" />
    /// </summary>
    public class CommService : ICommService
    {
        ...
        /// </summary>
        private readonly ICommRepository _repository;

        /// <summary>
        /// Initializes a new instance of the <see cref="CommService"/> class.
        /// </summary>
        /// <param name="repository">The repository<see cref="ICommRepository"/></param>
        public CommService(ICommRepository repository)
        {
        ...
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult GetComm(int id)
        {
        ...
        /// <param name="refining">The refining<see cref="Refining"/></param>
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult GetComm(Refining refining)
        {
        ...
        /// The Save
        /// </summary>
        /// <param name="entity">The entity<see cref="Comm"/></param>
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult Save(Comm entity)
        {
            try
            {
        ...
        /// <param name="entity">The entity<see cref="Comm"/></param>
        /// <returns>The <see cref="ServiceResult"/></returns>
        public ServiceResult Delete(Comm entity)
        {
            try
            {
